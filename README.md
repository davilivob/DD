...
2. Copy the codes from line 1 to line 314 inside the file, then paste them to the `Program.cs`.
3. Copy the codes from line 318 'till the end, then paste them to the `.csproj` file.
